...
from Zayan.utils.decorators.admins import ActualAdminCB
from Zayan.utils.decorators.language import language, languageCB
from Zayan.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Zayan.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("dil_Zayan") & ~BANNED_USERS)
@languageCB
