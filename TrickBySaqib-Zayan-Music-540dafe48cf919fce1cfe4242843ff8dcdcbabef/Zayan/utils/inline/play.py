...
from Zayan.utils.formatters import time_to_seconds
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        # Row 4: Support buttons
        [
            InlineKeyboardButton("𝑭𝑹𝑬𝑬 𝑷𝑹𝑶𝑴𝑶𝑻𝑰𝑶𝑵 📢", url="https://t.me/+iJhSFalhKFoyZGJl")            
        ],
...
def stream_markup(_, chat_id):
    buttons = [
       ...
       [
            InlineKeyboardButton(
                text="✰ ᴜᴘᴅᴧᴛᴇ ✰", url=SUPPORT_CHANNEL
            ),
            InlineKeyboardButton(
                text="✰ sᴜᴘᴘᴏꝛᴛ ✰", url=SUPPORT_CHAT
            )
        ],
