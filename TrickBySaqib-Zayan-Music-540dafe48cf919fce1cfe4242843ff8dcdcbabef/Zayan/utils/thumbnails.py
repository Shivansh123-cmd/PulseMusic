...
from Zayan.misc import db  # ✅ added for chat_id → user_id fetch
...
async def get_thumb(videoid: str, chat_id: int = None) -> str:
    ...
    try:
        title_font = ImageFont.truetype("Zayan/assets/FIGHTBACK.ttf", 32)
        regular_font = ImageFont.truetype("Zayan/assets/font2.ttf", 18)
    except OSError:
    ...
    # 🎵 Play icon
    icons_path = "Zayan/assets/play_icons.png"
    ...
    font = ImageFont.truetype("Zayan/assets/font.ttf", 28)
    text = "@SynBots"
