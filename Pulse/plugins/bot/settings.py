...
from Pulse.utils.decorators.admins import ActualAdminCB
from Pulse.utils.decorators.language import language, languageCB
from Pulse.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from Pulse.utils.inline.start import private_panel
...
@app.on_callback_query(filters.regex("dil_Pulse") & ~BANNED_USERS)
@languageCB
